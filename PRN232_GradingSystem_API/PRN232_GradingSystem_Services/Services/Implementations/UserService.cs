...
namespace PRN232_GradingSystem_Services.Services.Implementations
{
    public class UserService : CrudService<User, UserBM>, IUserService
    {
        ...
        protected override PRN232_GradingSystem_Repositories.Repositories.Interfaces.IEntityRepository<User>
        ...
        {
            User? user = await _unitOfWork.UserRepository.GetByUsernameAsync(usernameOrEmail);
        ...
        private async Task<AuthResultModel> GenerateAuthResultAsync(User user)
        {
