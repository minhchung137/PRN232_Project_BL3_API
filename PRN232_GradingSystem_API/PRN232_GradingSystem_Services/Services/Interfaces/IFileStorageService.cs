...
{
    Task<IReadOnlyList<string>> UploadArchiveAsync(Stream contentStream, string fileName, string contentType, string prefix, int examId, string? entityName = null, CancellationToken cancellationToken = default);
